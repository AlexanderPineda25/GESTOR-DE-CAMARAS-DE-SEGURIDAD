...
public interface RedisService {
    ...
    void cacheVideoFragment(Long cameraId, int fragmentIndex, byte[] fragmentBytes, int ttlSec);
    Optional<byte[]> getVideoFragment(Long cameraId, int fragmentIndex);
    void deleteAllVideoFragments(Long cameraId, int maxFragments);
    List<byte[]> getVideoFragments(Long cameraId, int startIndex, int endIndex);
    int getLastFrameIndexFromRedis(Long cameraId);
}
